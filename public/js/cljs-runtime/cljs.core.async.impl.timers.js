...
var i_38447 = (0);
while(true){
if((i_38447 < arr.length)){
(arr[i_38447] = null);

var G__38448 = (i_38447 + (1));
i_38447 = G__38448;
continue;
} else {
}
...
var i_38463 = (self__.level + (1));
while(true){
if((i_38463 <= (new_level + (1)))){
(update[i_38463] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_38465 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_38465[i]));
} else {
x__$2.forward.push((((i < links_38465.length))?(links_38465[i]):null));
}

if((i < links_38465.length)){
(links_38465[i] = x__$2);
} else {
links_38465.push(x__$2);
}
...
var i_38468 = (0);
while(true){
if((i_38468 <= self__.level)){
var links_38469 = (update[i_38468]).forward;
if((x__$1 === (((i_38468 < links_38469.length))?(links_38469[i_38468]):null))){
(links_38469[i_38468] = (x__$1.forward[i_38468]));

var G__38470 = (i_38468 + (1));
i_38468 = G__38470;
continue;
} else {
var G__38471 = (i_38468 + (1));
i_38468 = G__38471;
continue;
}
} else {
...
var G__38483 = nx;
var G__38484 = (level__$1 - (1));
x = G__38483;
level__$1 = G__38484;
continue;
} else {
var G__38485 = x;
var G__38486 = (level__$1 - (1));
x = G__38485;
level__$1 = G__38486;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__38495 = nx;
var G__38496 = (level__$1 - (1));
x = G__38495;
level__$1 = G__38496;
continue;
} else {
var G__38497 = x;
var G__38498 = (level__$1 - (1));
x = G__38497;
level__$1 = G__38498;
continue;
}
