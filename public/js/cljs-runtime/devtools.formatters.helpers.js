...
var G__30413 = devtools.prefs.pref(v);
v = G__30413;
continue;
} else {
return v;
...
}catch (e30369){var _e__29371__auto__ = e30369;
return false;
}})();
...
}catch (e30375){var _e__29371__auto__ = e30375;
return false;
}})();
...
}catch (e30377){var _e__29371__auto__ = e30377;
return false;
}}
}
});
...
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30393,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30393,(1),null);
...
return cljs.core.some((function (p1__30398_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__30398_SHARP_);
}),template);
});
