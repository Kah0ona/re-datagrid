...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_37322 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_37322(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_37323 = (function (runtime,key,spec){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_37323(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_37324 = (function (runtime,key){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_37324(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_37325 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_37325(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_37334 = (function (runtime,input,callback){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_37334(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_37335 = (function (runtime,code,success,fail){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_37335(runtime,code,success,fail);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__37298,callback){
var map__37299 = p__37298;
var map__37299__$1 = cljs.core.__destructure_map(map__37299);
var input = map__37299__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37299__$1,new cljs.core.Keyword(null,"code","code",1586293142));
