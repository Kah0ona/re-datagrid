...
var G__44064 = o;
reagent.impl.template.goog$module$goog$object.set(G__44064,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
G__44170.cljs$lang$applyTo = (function (arglist__44177){
...
var G__44072 = o;
reagent.impl.template.goog$module$goog$object.set(G__44072,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__44178__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
return G__44178__delegate.call(this,args);};
G__44178.cljs$lang$maxFixedArity = 0;
G__44178.cljs$lang$applyTo = (function (arglist__44182){
var args = cljs.core.seq(arglist__44182);
return G__44178__delegate(args);
});
...
var G__44077 = props;
var G__44077__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__44077,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__44077);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__44077__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5025__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__44079 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__44079,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__44079;
}
})(),id_class);
...
var temp__5823__auto___44183 = (function (){var and__5023__auto__ = js_props;
...
if(cljs.core.truth_(temp__5823__auto___44183)){
var d_44184 = temp__5823__auto___44183;
if((d_44184 instanceof reagent.impl.template.UnsafeHTML)){
(js_props.dangerouslySetInnerHTML = ({"__html": d_44184.s}));
} else {
...
var G__44085 = (cljs.core.count(argv) - first_child);
switch (G__44085) {
case (0):
...
var vec__44102 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44102,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44102,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44102,(2),null);
...
var temp__5827__auto___44193 = reagent.impl.util.react_key_from_vec(v);
if((temp__5827__auto___44193 == null)){
} else {
var key_44194 = temp__5827__auto___44193;
(jsprops.key = key_44194);
}
...
var temp__5827__auto___44195 = reagent.impl.util.react_key_from_vec(v);
if((temp__5827__auto___44195 == null)){
} else {
var key_44196 = temp__5827__auto___44195;
(jsprops.key = key_44196);
}
...
var temp__5827__auto___44200 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5827__auto___44200 == null)){
} else {
var key_44201 = temp__5827__auto___44200;
(jsprops.key = key_44201);
}
...
var temp__5827__auto___44203 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5827__auto___44203 == null)){
} else {
var key_44204 = temp__5827__auto___44203;
(jsprops.key = key_44204);
}
...
var temp__5827__auto___44206 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5827__auto___44206 == null)){
} else {
var key_44207 = temp__5827__auto___44206;
(jsprops.key = key_44207);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__44120_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__44120_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__44121 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44121,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44121,(1),null);
...
break;
default:
var G__44219 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__44220 = compiler;
v = G__44219;
compiler = G__44220;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template44145 = (function (opts,id,fn_to_element,parse_fn,meta44146){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template44145.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_44147,meta44146__$1){
var self__ = this;
var _44147__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template44145(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta44146__$1));
}));

(reagent.impl.template.t_reagent$impl$template44145.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_44147){
var self__ = this;
var _44147__$1 = this;
return self__.meta44146;
}));

(reagent.impl.template.t_reagent$impl$template44145.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template44145.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template44145.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template44145.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template44145.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template44145.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta44146","meta44146",218614645,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template44145.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template44145.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template44145");

(reagent.impl.template.t_reagent$impl$template44145.cljs$lang$ctorPrWriter = (function (this__5310__auto__,writer__5311__auto__,opt__5312__auto__){
return cljs.core._write(writer__5311__auto__,"reagent.impl.template/t_reagent$impl$template44145");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template44145.
 */
reagent.impl.template.__GT_t_reagent$impl$template44145 = (function reagent$impl$template$__GT_t_reagent$impl$template44145(opts,id,fn_to_element,parse_fn,meta44146){
return (new reagent.impl.template.t_reagent$impl$template44145(opts,id,fn_to_element,parse_fn,meta44146));
});
...
return (new reagent.impl.template.t_reagent$impl$template44145(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
