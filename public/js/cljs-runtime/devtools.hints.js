...
var map__29698 = top_item;
var map__29698__$1 = cljs.core.__destructure_map(map__29698);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29698__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29698__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29698__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e29696){var _e = e29696;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5821__auto___29783 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5821__auto___29783)){
var seen_errors_29784 = temp__5821__auto___29783;
if(cljs.core.truth_(seen_errors_29784.has(self))){
} else {
seen_errors_29784.add(self);

var temp__5823__auto___29785 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5823__auto___29785)){
var sense_29787 = temp__5823__auto___29785;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_29787)].join(''));
} else {
}
}
} else {
